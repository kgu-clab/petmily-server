package com.clab.securecoding.auth.jwt;

import com.clab.securecoding.auth.exception.TokenValidateException;
...
public class JwtTokenProvider {
    ...
    private static final long REFRESH_TOKEN_DURATION = 40L * 60L * 1000L;
