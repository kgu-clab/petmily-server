...
values ('tester1', '{bcrypt}$2a$10$TA0btCubK9nayV8yJHmNo.kKTG30ECMVWQT8ed6LRl1yzZY1oZTsG', 'tester1',
        'tester1@gmail.com', '수원시', '01051476788', 'INDIVIDUAL', 'USER', 'LOCAL', '2023-08-18 01:57:43.000000');
insert into user(id, password, nickname, email, address, contact, type, role, provider, created_at)
values ('tester2', '{bcrypt}$2a$10$owcdmT6My36VUzlJQin6.ujxwDPJtk32hHQWIdqiU74vSZewFgD1u', 'tester2',
        'tester2@gmail.com', '수원시', '01051476788', 'INDIVIDUAL', 'USER', 'LOCAL', '2023-08-18 01:57:46.000000');
insert into user(id, password, nickname, email, address, contact, type, role, provider, created_at)
values ('tester3', '{bcrypt}$2a$10$H1olmR5kIM6Z8MrB7EtjXeO.YrhvE4OaWcujVrnAUsS2IgBKjSEDa', 'tester3',
        'tester3@gmail.com', '수원시', '01051476788', 'SHELTER', 'USER', 'LOCAL', '2023-08-18 01:57:44.000000');
insert into user(id, password, nickname, email, address, contact, type, role, provider, created_at)
values ('tester4', '{bcrypt}$2a$10$UlsA3WbfmBNa99hrn4/9oejidNpvqCmm0c43GOkWcXJQanmR3CklG', 'tester4',
        'tester4@gmail.com', '수원시', '01051476788', 'SHELTER', 'USER', 'LOCAL', '2023-08-18 01:57:47.000000');
...
values ('pro', '{bcrypt}$2a$10$nLS1otiVKm5u9ZUJJrwT3uDcfFFLWx4PA2OMpta2ex5AnkTZxODaq', 'pro',
        'pro@pro.com', '태안군', '01051476788', '3213-321312-21', 'PROFESSIONAL', 'USER', 'LOCAL', '2023-08-18 01:57:50.000000');
...
-- AnimalAdoptionBoard
INSERT INTO animal_adoption_board(id, adaptability, age, animal_state, animal_type, areas_available, birth_day, color, created_at, favorite_snack, gender, img_url, independence, initiative, is_neutered, leadership, name, positivity, price, reason_for_adoption, recommendation, species, think, vaccine, weight, user)
VALUES (5,10,3,'FIND','DOG','수원','3월 23일','갈색','2023-08-16 19:13:04.805947','고구마','여자','[\"/resources/files/animals/pro/318412576840004_318c2efa-798e-4b25-b5cc-b97cf2d69d31.png\",\"/resources/files/animals/pro/318412683656463_28660f03-4416-4152-9047-b3ee1aaf367d.jpg\"]',8.8,8.9,'무',5,'누렁이',6.7,100000,'<p><strong>참고사항은 없습니다.</strong></p>','마당이 있는 집','시고르자브종','산책을 자주 못해주는 분','2차 완료',23.5,6);
